    ...
    public class ProductController : Controller
    {
        ...
        public ContentResult GetEmpName(int id) 
        {
            ...
            var employees = new[]
            {
                ...
                new {EmpID=102,EmpName="Scott",Salary=34567 },
                new {EmpID=103,EmpName="Madhu",Salary=123457 },
                new {EmpID=104,EmpName="Prasad",Salary=64564 }
        ...
        //public RedirectResult GotoFacebook()
        //{
